...
export default {
  ...
  created() {
    ...
    if (savedEmail) {
      ...
      this.rememberedEmail = savedEmail;
      this.check = true;
    }
  },
  methods: {
    ...
    handleSubmit() {
      ...
      if (!this.validatePassword()) {
        alert(
          "Password must be at least 4 characters long and contain at least one lowercase letter, one uppercase letter, and one special character."
        );
        return;
      }
      if (this.check) {
