...
import fetchUpcoming from "../utils/fetchUpcoming";
...
export default function Upcoming() {
  ...
  if (loading)
    return <div className="text-white">Loading Upcoming Movies...</div>;
  ...
  return (
    <article className="bg-black py-10 px-4 xs:px-0">
      <section className="container mx-auto py-8 text-white">
        ...
        <h2 className="text-[36px] font-bold mb-8">Upcoming Movies</h2>
